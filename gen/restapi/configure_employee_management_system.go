...
func configureAPI(api *operations.EmployeeManagementSystemAPI) http.Handler {
	...
	if api.ListEmployeesHandler == nil {
		api.ListEmployeesHandler = operations.ListEmployeesHandlerFunc(func(params operations.ListEmployeesParams) middleware.Responder {
